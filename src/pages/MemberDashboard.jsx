    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-3">
                ...
                <span className="text-sm font-semibold text-gray-500">Memuat Member Area...</span>
            </div>
        );
    }
        ...
        <div className="bg-[#f8f9fa] min-h-screen font-inter pb-16">
            ...
            <header className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between sticky top-0 z-50">
                <div className="flex items-center gap-3">
                    <div className="w-9 h-9 bg-ocean-green rounded-xl flex items-center justify-center text-white font-bold">
                        +
                    </div>
                ...
                <div className="space-y-4 text-left">
                    ...
                    <div className="bg-white border border-gray-100 rounded-2xl divide-y divide-gray-50 shadow-sm overflow-hidden">
                        <div className="p-4 flex items-center justify-between text-sm text-gray-500">
                            <span className="flex items-center gap-2 font-medium text-cyprus">
