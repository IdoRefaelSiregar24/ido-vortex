        ...
        <div className="flex flex-col space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
            ...
            <div className="flex justify-between items-center bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                <div className="flex items-center space-x-4 w-full md:w-auto">
                    ...
                    <button className="flex items-center space-x-2 text-gray-600 hover:text-emerald-600 hover:bg-emerald-50 transition-colors px-3 py-2 rounded-lg border border-transparent">
